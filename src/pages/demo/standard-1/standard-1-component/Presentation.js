...
import image1 from '../standard-1-images/musculation.png'; // Remplacez par le bon chemin
import image2 from '../standard-1-images/cardio.png'; // Remplacez par le bon chemin
import image3 from '../standard-1-images/diet.png'; // Remplacez par le bon chemin
      ...
      <div className="presentation__icons">
        ...
        <div className="presentation__icon">
            <div className="presentation__icon-mask"> 
                ...
                <h3 className="presentation__icon-title">Cardio</h3>
                <p className="presentation__icon-paragraph">
